      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <Link
            ...
            className="text-xs sm:text-sm font-bold text-[#0B4F26] hover:text-[#095740] flex items-center gap-1.5 shrink-0 self-start md:self-end group"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {partnershipsData.map((partner) => (
            <div
              key={partner.id}
              className="bg-[#F7F8F6] rounded-2xl p-6 hover:border-[#0B4F26]/40 hover:bg-[#E8F7F0]/40 transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-xl bg-white text-[#0B4F26] flex items-center justify-center shadow-xs">
