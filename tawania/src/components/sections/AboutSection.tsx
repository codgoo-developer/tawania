      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-start">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#0B4F26] tracking-tight leading-[1.15]">
              {locale === 'ar' ? (
                <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              {/* Card 1: Vision */}
              <div className="p-6 rounded-2xl bg-[#E8F7F0]/70 border border-[#0B4F26]/5 flex flex-col justify-between space-y-4">
                <div className="w-12 h-12 rounded-full bg-white text-[#0B4F26] shadow-xs flex items-center justify-center">
                  <Eye className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-[#0B4F26] mb-1.5">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden shadow-xl aspect-4/5 max-w-md mx-auto bg-gradient-to-br from-[#0B4F26] to-[#0B211C]">
              <img
