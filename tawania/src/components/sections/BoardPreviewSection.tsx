...
export const BoardPreviewSection: React.FC = () => {
  ...
  const getRoleStyle = (order: number = 99, roleAr: string = '') => {
    ...
    if (order === 2 || roleAr.includes('نائب')) {
      return 'bg-[#E8F7F0] text-[#0B4F26] border border-[#0B4F26]/20';
    }
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white via-[#F7F8F6] to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#0B4F26]/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#F59E0B]/5 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        {/* Section Header */}
        <div className="text-center max-w-4xl mx-auto mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0B4F26]/10 border border-[#0B4F26]/20 text-[#0B4F26] text-xs sm:text-sm font-bold mb-3 shadow-2xs">
                ...
                <div className="mt-auto w-full pt-3 border-t border-[#0F172A]/5 space-y-1.5 text-xs text-[#525E59]">
                  {member.phone && (
                    <a
                      ...
                      className="flex items-center justify-center gap-1.5 p-1.5 rounded-xl bg-[#F7F8F6] hover:bg-[#E8F7F0] font-bold text-[#0B4F26] transition-colors dir-ltr"
                    >
        ...
        <div className="mt-14 bg-gradient-to-br from-[#063325] via-[#094734] to-[#0B4F26] rounded-3xl p-6 sm:p-8 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 border border-emerald-500/20">
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-start">
            <div className="relative w-18 h-18 sm:w-22 sm:h-22 rounded-full p-1 bg-gradient-to-br from-[#F59E0B] via-[#E2C37E] to-[#0B4F26] shrink-0 shadow-lg">
              <div className="w-full h-full rounded-full bg-gradient-to-br from-[#0B4F26] to-[#042419] overflow-hidden flex items-center justify-center border-2 border-white/80 shadow-inner">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full sm:w-auto justify-center">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-white text-[#0B4F26] hover:bg-emerald-50 text-xs sm:text-sm font-bold shadow-md transition-colors cursor-pointer"
            >
